...
import DraggableIndicatorCard, { IndicatorCardMeta } from './dragComps/IndictorCard';
...
export const ComponentsMap: Record<string, React.ComponentType<any> | React.ForwardedRef<any>> = {
  ...
  IndicatorCard: DraggableIndicatorCard
}
